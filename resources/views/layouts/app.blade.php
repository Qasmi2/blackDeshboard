...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/favicon.png">
    ...
    <title>{{ config('app.name', 'MONTVIRO EVENT') }}</title>
    <!-- Scripts -->
...
<div id="app">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">WIZKON SOLUTION</a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                        ...
                        @else
                           <li class="nav-item">
                                <a class="nav-link" href="{{ route('showform') }}">{{ __('Add New') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('views') }}">{{ __('View Records') }}</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }} <span class="caret" style="left:90% !important;"></span>
                                </a>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            </script> DEVELOPED <i class="tim-icons icon-heart-2"></i> BY
            <a href="javascript:void(0)" target="_blank"></a> WIZKON SOLUTION
          </div>
        </div>
      </footer>
    </div>
  ...
  <script src="{{ asset('js/black-dashboard.min.js') }}" defer></script>
